...
public class AuthUserDto implements OAuth2User, OidcUser {
    ...
    public static AuthUserDto create(PersonEntity person, Map<String, Object> attributes,
            OidcIdToken idToken, OidcUserInfo userInfo) {
        return AuthUserDto.builder().email(person.getEmail()).password(person.getPassword())
